...
### Table des matières
   ...
   * [Conventions de nomenclature](#conventions-de-nomenclature)
      * [Conventions générales de nomenclature](#conventions-générales-de-nomenclature)
        * [2 | Le nom des classes doit être en minuscules avec le premier caractère en majuscule, ainsi que le début de chaque nouveau mot](#2--le-nom-des-classes-doit-être-en-minuscules-avec-le-premier-caractère-en-majuscule-ainsi-que-le-début-de-chaque-nouveau-mot)
        * [3 | Le nom des variables, fonctions et paramètres est en minuscule. Chaque mot est séparé d'un tiret-bas _](#3--le-nom-des-variables-fonctions-et-paramètres-est-en-minuscule-chaque-mot-est-séparé-dun-tiret-bas-_)
        * [4 | Le nom des constantes est tout en majuscules, les mots séparés de tirets bas](#4--le-nom-des-constantes-est-tout-en-majuscules-les-mots-séparés-de-tirets-bas)
        * [5 | Le nom des fonctions commence par un verbe suivi de mots séparés par des tirets_bas](#5--le-nom-des-fonctions-commence-par-un-verbe-suivi-de-mots-séparés-par-des-tirets_bas)
        * [13 | Les noms doivent être tous en anglais ou tous en français](#13--les-noms-doivent-être-tous-en-anglais-ou-tous-en-français)
        * [14 | Les variables qui ont une longue portée peuvent avoir des noms longs. Ceux avec une portée réduite peuvent avoir des noms courts](#14--les-variables-qui-ont-une-longue-portée-peuvent-avoir-des-noms-longs-ceux-avec-une-portée-réduite-peuvent-avoir-des-noms-courts)
      * [Conventions générales de nomenclature](#conventions-générales-de-nomenclature-1)
        * [17 | Le terme « calculer » (« compute » en anglais) peut être employé dans des méthodes où quelque chose est calculé](#17--le-terme--calculer---compute--en-anglais-peut-être-employé-dans-des-méthodes-où-quelque-chose-est-calculé)
        * [18 | Le terme « trouver » (« find » en anglais) devrait être employé dans des méthodes où on effectue une recherche](#18--le-terme--trouver---find--en-anglais-devrait-être-employé-dans-des-méthodes-où-on-effectue-une-recherche)
        * [21 | La forme plurielle devrait être employée pour les noms représentant une collection d'objets](#21--la-forme-plurielle-devrait-être-employée-pour-les-noms-représentant-une-collection-dobjets)
        * [22 | Le préfixe « n » devrait être employé pour des variables représentant un nombre d'objets](#22--le-préfixe--n--devrait-être-employé-pour-des-variables-représentant-un-nombre-dobjets)
        * [24 | Les variables d'itération devraient être appelées i, j, k etc. (mais jamais l)](#24--les-variables-ditération-devraient-être-appelées-i-j-k-etc-mais-jamais-l)
        * [25 | Le préfixe « is » en anglais ou « est » en français devrait être employé pour les méthodes et variables booléennes.)](#25--le-préfixe--is--en-anglais-ou--est--en-français-devrait-être-employé-pour-les-méthodes-et-variables-booléennes)
        * [26 |	Des noms complémentaires doivent être utilisés pour des entités (fonctions, variables, etc.) complémentaires [1].](#26-des-noms-complémentaires-doivent-être-utilisés-pour-des-entités-fonctions-variables-etc-complémentaires-1)
        * [27 |	Les abréviations devraient être évitées dans les noms.](#27-les-abréviations-devraient-être-évitées-dans-les-noms)
        * [29 |	La négation des noms des variables booléennes doit être évitée.](#29-la-négation-des-noms-des-variables-booléennes-doit-être-évitée)
        * [32 |	Les fonctions (méthodes retournant quelque chose) devraient être nommées d'après ce qu'elles retournent et les procédures (méthodes ne retournant rien, c'est-à-dire void) d'après ce qu'elles font.](#32-les-fonctions-méthodes-retournant-quelque-chose-devraient-être-nommées-daprès-ce-quelles-retournent-et-les-procédures-méthodes-ne-retournant-rien-cest-à-dire-void-daprès-ce-quelles-font)
   * [Les fichiers](#les-fichiers)
      * [Fichiers sources](#fichiers-sources)
        * [33 |	Un fichier source doit toujours comporter un entête de programme.](#33-un-fichier-source-doit-toujours-comporter-un-entête-de-programme)
        * [37 |	Le contenu d'un fichier ne doit pas dépasser 80 colonnes](#37-le-contenu-dun-fichier-ne-doit-pas-dépasser-80-colonnes)
        * [38 | La césure des lignes trop longues doit être effectuée d'une manière lisible, logique et évidente [1].](#38--la-césure-des-lignes-trop-longues-doit-être-effectuée-dune-manière-lisible-logique-et-évidente-1)
        * [42 |	Les énoncés d'import doivent se trouver seulement au début d'un fichier.](#42-les-énoncés-dimport-doivent-se-trouver-seulement-au-début-dun-fichier)
   * [Les déclarations](#les-déclarations)
      * [Variables](#variables)
        * [46 |	Les variables devraient être initialisées lorsqu'elles sont déclarées](#46-les-variables-devraient-être-initialisées-lorsquelles-sont-déclarées)
        * [47 |	Les variables ne doivent jamais avoir plus d'une signification.](#47-les-variables-ne-doivent-jamais-avoir-plus-dune-signification)
        * [48 |	L'utilisation de variables globales doit être évitée.](#48-lutilisation-de-variables-globales-doit-être-évitée)
        * [51 |	Le test implicite de comparaison avec 0 (ou True) ne devrait être utilisé.](#51-le-test-implicite-de-comparaison-avec-0-ou-true-ne-devrait-être-utilisé)
        * [52 |	Les variables devraient être gardées vivantes le moins longtemps possible.](#52-les-variables-devraient-être-gardées-vivantes-le-moins-longtemps-possible)
        * [56 |	L'utilisation de break et continue dans les boucles devrait être évitée](#56-lutilisation-de-break-et-continue-dans-les-boucles-devrait-être-évitée)
      * [Instructions conditionnelles](#instructions-conditionnelles)
        * [58 | Les expressions conditionnelles complexes doivent être évitées. Introduire plutôt des variables booléennes temporaires [1]](#58--les-expressions-conditionnelles-complexes-doivent-être-évitées-introduire-plutôt-des-variables-booléennes-temporaires-1)
        * [61 | Des énoncés qui exécutent du traitement ne doivent pas se trouver à l'intérieur de conditions.](#61--des-énoncés-qui-exécutent-du-traitement-ne-doivent-pas-se-trouver-à-lintérieur-de-conditions)
      * [Divers](#divers)
...
#### 89 | Les fonctions devraient être munies d'un en-tête respectant le format docstring PEP257
